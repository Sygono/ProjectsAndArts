...
public class DebugShapes : MonoBehaviour {
    ...
    public static void DrawLine(Vector2 pos, Vector2 end, Color col, float duration = 0f) {
        DrawLine(new Vector3(pos.x, pos.y, 0), new Vector3(end.x, end.y, 0), col, duration);
    }
    ...
    public static void DrawPoint(Vector3 pos, float scale, Color col, float duration = 0.0f) {
